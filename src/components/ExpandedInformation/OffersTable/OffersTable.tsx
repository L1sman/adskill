...
import {columns} from "./OffersTableColumns/OffersTableColumns.tsx";
import type {Client} from "../../../lib/types.ts";
import cls from './OffersTable.module.scss';
import SearchIcon from '../../../assets/svg/search.svg?react';
import Arrow from '../../../assets/svg/arrow.svg?react';
import Plus from '../../../assets/svg/plus.svg?react';


const OffersTable = observer(({client}: { client: Client }) => {
  ...
  return (
    <div className={cls.subTableContainer}>
      <h3 className={cls.tableTitle}>Offers</h3>
